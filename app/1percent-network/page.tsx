...
<section className="networkHero"><div className="portalWrap"><div className="eyebrow">1% NETWORK · SHARED PROFESSIONAL NETWORK</div><h1>每一種專業， 都可能成為某個人的 1%。</h1><p>這不是會員名錄，也不是商會席位。它讓已經連上的專業被看見，也讓尚缺的一塊保持可見。</p></div></section>
